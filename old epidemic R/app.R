...
if(n == 0){
    data.all <- readr::read_csv("https://www.stat2games.sites.grinnell.edu/data/epidemic/getdata.php") 
...
ui <- fluidPage(
    ...
    #App Title
    titlePanel("Epidemic Data Visualizations"),
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            selectInput(inputId = "xvar",
                        label = "X Variable:",
                        choices = c("Medicine", "Virus", "Level", "Wave", "PlayerID", "Location", "TurretType", "Upgrade"),
                        selected = "Medicine",
                        multiple = FALSE),
            
            selectInput(inputId = "facet",
                        label = "Facet by:",
                        choices = c("None", "Medicine", "Virus", "Level", "Wave", "PlayerID", "Location", "TurretType", "Upgrade"),
                        selected = "None",
                        multiple = FALSE),
            ...
            downloadButton('downloadData', label = "Epidemic Data"),
            
            a(h5("Instructor Details"),
              href="https://stat2labs.sites.grinnell.edu/epidemic.html", 
